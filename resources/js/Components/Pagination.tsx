            ...
            <div className="flex items-center space-x-2">
                {pages.map((page) => (
                    <button
                        ...
                        className={`flex h-10 w-10 items-center justify-center rounded-full text-xs font-sans transition-all duration-300 ${
                            currentPage === page
                                ? 'bg-[#FDF9F1] text-[#0F0F0F] font-bold'
                                : 'text-[#E5E1D8] hover:text-[#FDF9F1] hover:bg-[#222]'
                        }`}
                    >
                        {page}
                    </button>
